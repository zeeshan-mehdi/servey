...
$database ="landing_db";
    ...
    if(isset($_POST['savedata'])){
        ...
        if(!empty($_POST['question'])){
            ...
            $sql = "INSERT INTO servey_question (selected_option,ip,dtm)
...
<h3 style="word-spacing: 5px; line-height: 30px;margin-top:-30px;">How much amount of money are you willing to pay per km's if you are provided with a platform that aim's towards the ride sharing and to reduce the improper utilization of resources in order to save the environment?
</h3>
<br><br>
...
<label for="male"> &nbsp;&nbsp;&nbsp; Rs.15</label><br><br>
<input type="radio"  name="question" value="$5.99">
<label for="female">&nbsp;&nbsp;&nbsp;Rs.25</label><br><br>
<input type="radio"  name="question" value="$6.99">
<label for="male">&nbsp;&nbsp;&nbsp;Rs.30</label><br><br>
...
<input type="submit" name="savedata" value="Submit" class="button button5">
    <a href="survey2.php">
        <input type="next" name="proceed" value="Next" class="button button6" style="width: 120px">
    </a>
</form>
